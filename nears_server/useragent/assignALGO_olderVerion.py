...
def agent(action,agent_instance):
    if action =="add":
        ...
        try:
            ...
            # issue////////////////////////////////////////////////////////////////////////////////////////////////////
             # issue////////////////////////////////////////////////////////////////////////////////////////////////////
            del g[agent_instance]
            d= AgentClass("DELETE",agent_instance)
             # issue////////////////////////////////////////////////////////////////////////////////////////////////////
             # issue////////////////////////////////////////////////////////////////////////////////////////////////////

            d.setState(False)
            g.insert(agent_instance,d)
            cache.set(agent_key,g) 
...
def update_agent(action,agent_index):
    if action == "busy":
        ...
        g = list(cache.get(agent_key))
        g[agent_index].setState(True)
        agentName = g[agent_index].getAgent()
        cache.set(agent_key,g)
        try:
            if len(cache.get(case_key)) > 0:
                ...
                del g[0]
                cache.set(case_key,g)
                assignWhenLessBusy(oldCaseID,agentName)
        except:
            pass
